...
# CONFIGURATION
# =============================================================================
PROJECT_ROOT="/sfs/weka/scratch/nkw3mr/Vision-OPD"
CONFIG_NAME="vopd"
...
DATA_DATALOADER_NUM_WORKERS=2
CUSTOM_CHAT_TEMPLATE_FILE="${PROJECT_ROOT}/chat_templates/perception_chat_template_qwen35.jinja"

# --- Data Paths ---
DATA_DIR="${PROJECT_ROOT}/data"
TASK_TRAIN_FILE="/sfs/weka/scratch/nkw3mr/Vision-OPD/data/train_bbox_text.parquet"
